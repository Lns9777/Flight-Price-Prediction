...
if st.button("Predict"):
    saved_processor = joblib.load("preprocessor.joblib")
    x_new_pre = saved_processor.transform(x_new)

    # with open("flight_price.pkl","rb") as f:
    data = bz2.BZ2File('flight_price.pbz2','rb')
